...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: `https://www.negativadoefeliz.com.br/og?title=Arquivo+de+Confissões&category=Blog`,
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    images: [`https://www.negativadoefeliz.com.br/og?title=Arquivo+de+Confissões&category=Blog`],
  },
};
